...
public class MainController implements Initializable {
    static void algorFormat(String algor) throws InvalidAlgorithm {
        if (algor == null) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("Empty pathfinding algorithm");
            alert.setContentText("Please choose a pathfinding algorithm");
            alert.show();
        }
    }
    @FXML
    ...
    ObservableList<String> listAlgorithm = FXCollections.observableArrayList("BFS", "DFS");
    @Override
    ...
    public void SUBMIT(ActionEvent event) {
        ...
        try {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("Size format error");
